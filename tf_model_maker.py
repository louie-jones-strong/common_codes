...
def accuracy_cal( inputs , targets , model , batch_size , decimal_places = 1):
    ...
    print("")
    print("input: " + str(inputs[int(len(inputs)/2)]))
    print("output: " + str(outputs[int(len(inputs)/2)]))
    print("target: " + str(targets[int(len(inputs)/2)]))
    print("")
    print("input: " + str(inputs[len(inputs)-1]))
    print("output: " + str(outputs[len(inputs)-1]))
    print("target: " + str(targets[len(inputs)-1]))
